...
public class Arbol<T extends Comparable<T>> {
	...
	private void preOrden(NodoArbol<T> arbol) {
		if(arbol!=null) {
			System.out.print(arbol.getClave() + " ");
			preOrden(arbol.getIz());
			preOrden(arbol.getDe());
		}
	}
	
	public void ordenCentral() {
		ordenCentral(this.getRaiz());
	}
	
	private void ordenCentral(NodoArbol<T> arbol) {
		if(arbol!=null) {			
			ordenCentral(arbol.getIz());
			System.out.print(arbol.getClave() + " ");
			ordenCentral(arbol.getDe());
		}
	}
	...
	private void postOrden(NodoArbol<T> arbol) {
		if(arbol!=null) {			
			postOrden(arbol.getIz());			
			postOrden(arbol.getDe());
			System.out.print(arbol.getClave() + " ");
		}
	}
	...
	public static <T extends Comparable<T>> void juntar(Arbol<T> arbol, T dato, Arbol<T> a1, Arbol<T> a2) {
		if(a1 == null && a2 == null)
